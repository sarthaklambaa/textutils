...
export default function Textform(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'black'}}>
            ...
            <button className="btn btn-danger mx-1 my-1" onClick={handleLower}>Convert to LowerCase</button>
            ...
            <button className="btn btn-info mx-1 my-1" onClick={handleClear}>Clear Text</button>
        </div>

        <div className="container my-4" style={{color: props.mode==='dark'?'white':'black'}}>
            <h2>Your Text Summary</h2>
            <p>{text.split(" ").length} words and {text.length} characters</p>
            <p>It will take about <b>{0.008 * text.split(" ").length} minutes </b> to read the above text</p>
            <h2>Preview</h2>
